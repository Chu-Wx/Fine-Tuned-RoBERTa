...
class BoolQDataset(Dataset):
    ...
    def __init__(self, dataframe, tokenizer, max_seq_length=256):
        ...
        self.input_ids=self.encoded_data[0]
        self.attention_mask=self.encoded_data[1]
    ...
    def __getitem__(self, i):
        ...
        return {'input_ids':self.input_ids[i],'attention_mask':self.attention_mask[i],'labels':self.label_list[i]}
